...
if __name__ == "__main__":
    ...
    aparser.add_argument("--start_not_before", type=flexdate, default=datetime.date.today())
    aparser.add_argument("--start_until", type=flexdate, default=datetime.date.today() + datetime.timedelta(days=365))
    aparser.add_argument("--max_away_days", type=int, default=14)
    aparser.add_argument("--min_stay_days", type=int, default=1)
    ...
    aparser.add_argument("--max_routes", type=int, default=100)
    aparser.add_argument("--sleep", type=float, default=2)
